import cv2
import numpy as np
from src.censor_engine.typing import CVImage
from src.censor_engine.models.detectors import DetectedPartSchema
...
if __name__ == "__main__":
    cv2.imwrite("test_test_meta.jpg", ImageGenerator().make_test_image())
