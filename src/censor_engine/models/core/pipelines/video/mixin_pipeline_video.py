...
from ...tools.debugger import DebugLevel, DevTools
from ...tools.dev_tools.video_tools import VideoInfo
from ..image.mixin_pipeline_image import ImageProcessor
from .processors.video import FrameProcessor, VideoProcessor
...
class MixinVideoPipeline(Mixin):
    ...
    def run_video_pipeline(
        ...
        _test_detection_output: list[list[DetectedPart]],
